...
private static final int REQUEST__PERMISSION_CODE = 1;
int languageCode,fromLanguageCode,toLanguageCode = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        micIV = findViewById(R.id.idTVMic);
        ...
        ArrayAdapter fromAdapter = new ArrayAdapter(this,R.layout.spineer_item,fromLanguages);
        ...
        ArrayAdapter toAdapter = new ArrayAdapter(this,R.layout.spineer_item,toLanguages);
        ...
        translateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(sourceEdt.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(MainActivity.this, "Please select the language to make  a translation", Toast.LENGTH_SHORT).show();
                }else{
        ...
        micIV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                        startActivityForResult(intent,REQUEST__PERMISSION_CODE);
                }catch (Exception e){
                    e.printStackTrace();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable  Intent data) {
        ...
        if(requestCode==REQUEST__PERMISSION_CODE){
    ...
    private void translateText(int fromLanguageCode, int toLanguageCode, String source) {
        translateTV.setText("Downloading Modal...");
            ...
            public void onSuccess(Void unused) {
                ...
                translator.translate(source).addOnSuccessListener(new OnSuccessListener<String>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MainActivity.this, "Failde to translate"+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }).addOnFailureListener(new OnFailureListener() {
